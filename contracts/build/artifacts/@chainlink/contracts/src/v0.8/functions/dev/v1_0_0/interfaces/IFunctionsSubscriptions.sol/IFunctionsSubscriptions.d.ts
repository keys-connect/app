...
export interface IFunctionsSubscriptions$Type {
  ...
  "sourceName": "@chainlink/contracts/src/v0.8/functions/dev/v1_0_0/interfaces/IFunctionsSubscriptions.sol",
  "abi": [
    {
      "inputs": [
        {
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "@chainlink/contracts/src/v0.8/functions/dev/v1_0_0/interfaces/IFunctionsSubscriptions.sol:IFunctionsSubscriptions",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IFunctionsSubscriptions$Type["abi"]>>;
