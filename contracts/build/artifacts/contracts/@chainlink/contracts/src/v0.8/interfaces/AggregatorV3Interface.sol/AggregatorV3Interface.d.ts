...
export interface AggregatorV3Interface$Type {
  ...
  "sourceName": "contracts/@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol",
  "abi": [
    {
      "inputs": [],
      "name": "decimals",
...
declare module "@nomicfoundation/hardhat-viem/types" {
  ...
  export function deployContract(
    contractName: "contracts/@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol:AggregatorV3Interface",
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<AggregatorV3Interface$Type["abi"]>>;
